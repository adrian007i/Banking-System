      ...
      <div id= "container" style="background-color:#34363a;">
         ...
         <div id="navMenu">
		  ...
		  <div id= "bottom">
             <h1>Deposit</h1>
			 <hr/>
            <form name="deposit"  action="../Controllers/deposit_process.php" method="post">
               <fieldset>
                  <legend>Deposit Section</legend>
                  Accounts Owned: #  
                  ...
                  <br/><br/>
                   Deposit Amount:  $ <input type="text" name="amt" id="amt" /><span class="errors"></span>
                  <br/><br/> 
                  <input type="submit"/>    
