...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
      <div id= "container">
        ...
        <div id= "bottom">
            <h2 style ="color:white;">Withdrawals</h2>
				<?php
				...
				if (mysqli_num_rows($results) > 0){ 
					...
					if($user_record['amount'] - $amount_to_withdraw < 0){
						echo "<br/><h1>Not enough Funds! <br/> Withdrawal Invalid </h1>";
					}
				

    				else{
						
						$query="Update accounts Set amount=amount - $amount_to_withdraw
								WHERE account_number='$acc';";
								
						if ($row=mysqli_query($connect,$query)){
						
							echo "<br/><h1>$amount_to_withdraw has successfully been withdrawed</h1>";
